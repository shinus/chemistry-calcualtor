...
var property = "force";
var box = [ "Newton (N)", "Dyne (dy)", "Kilogram force (kgf)", "Kilopond force (kpf)", "Kip (k)", "Ounce force (ozf)", "Pound force (lbf)", "Poundal"];
var fact = [1, 1E-05, 9.80665, 4448.22161525477, 4448.22161525477, 0.2780139, 4.44822161525477, 0.138255];
option2.value = 10
option1.value = 1;
