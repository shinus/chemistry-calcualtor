...
var box = [ "Kilogram/cub.meter", "Grain/galon", "Grams/cm³ (gr/cc)", "Pound mass/cubic foot", "Pound mass/cubic-inch", "Ounces/gallon (UK,liq)", "Ounces/gallon (US,liq)", "Ounces/inch³ (oz/in³)", "Pound mass/gal (UK,liq)", "Pound mass/gal (US,liq)", "Slug/cubic foot", "Tons (long,mass)/cub.yard"];
var fact = [1, 0.01711806104527, 1000, 16.01846337395, 27679.90471019, 6.236023291444, 7.489151707295, 1729.994044387, 99.7763726631, 119.8264273167, 515.3788183932, 1328.939183617];
option2.value = 10
option1.value = 1;
