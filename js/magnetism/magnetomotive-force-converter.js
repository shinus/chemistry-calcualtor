...
var property = "magnetomotive-force";

var box = [ "ampere turn (At)", "kiloampere turn (kAt)", "milliampere turn (mAt)", "abampere turn (abAt)", "gilbert (Gi)"];
var fact = [1, 1000, 0.001, 10, 0.795774715102267];
