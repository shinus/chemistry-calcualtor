...
var property = "magnetic-field-strength";

var box = [ "ampere/meter (A/m)", "ampere turn/meter (At/m)", "kiloampere/meter (kA/m)", "oersted (Oe)"];
var fact = [1, 1, 1000, 79.5774691038487];
option2.value = 10
option1.value = 1;
