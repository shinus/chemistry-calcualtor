...
var property = "enzymes";

var box = [ "nano-katal/liter (nkat/L)", "micro-katal/liter (µkat/L)", "nano-mole/second liter (nmonl/sL)", "micro-mole/second liter (µmol/sL)", "enzyme unit/liter (U/L)", "international unit/liter (IU/L)", "micro-mole/minute liter (µmol/min-L)", "micro-mole/hour liter (µmol/h-L)", "micro-mole/hour milli liter (µmol/h-mL)"];
var fact = [1, 1000, 1, 1000, 16.6666666666667, 16.6666666666667, 16.6666666666667, 0.277777777777778, 250];
