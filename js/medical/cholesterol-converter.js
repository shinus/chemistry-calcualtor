...
var box = [
  "milli-mole/liter (mmol/L)",
  "Micro-mole/liter (µmol/L)",
  "Milli-gram/deciliter (mg/dL)",
  "Milli-gram/100 milliliters (mg/100mL)",
  "Milli gram percent (mg%)",
  "milli-gram/liter (mg/L)",
  "micro-gram/milliliter (µg/mL)",
];
var fact = [
  1, 0.001, 0.025863183757921, 0.025863183757921, 0.0272739669985,
  0.002586318375792, 0.002586318375792,
];
