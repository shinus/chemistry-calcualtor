...
var property = "cholesterol";

var box = new Array( "milli-mole/liter (mmol/L)", "micro-mole/liter (µmol/L)", "gram/deciliter (g/dL)", "gram/100 milliliters (g/100mL)", "gram percent (g%)", "milli-gram/liter (mg/L)", "micro-gram/milliliter (µg/mL)");
var fact = new Array(1, 0.001, 0.249500998003992, 0.249500998003992, 0.249500998003992, 0.024951344877489, 0.024951344877489);

option2.value = 10;
option1.value = 1;
var precision = document.getElementById("precision");
function createDropDownForboxs(arr, element) {
  element.innerHTML = "";
...
function init() {
  createDropDownForboxs(box, Box);
  createDropDownForboxs(fact, Box2);
}
