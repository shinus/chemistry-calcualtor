...
var property = "radiation-activity";

var box = [ "becquerel (Bq)", "terabecquerel (TBq)", "gigabecquerel (GBq)", "megabecquerel (MBq)", "kilobecquerel (kBq)", "millibecquerel (mBq)", "curie (Ci)", "kilocurie (kCi)", "millicurie (mCi)", "microcurie (µCi)", "nanocurie (nCi)", "picocurie (pCi)", "rutherford", "one/second (1/s)", "disintegrations/second", "disintegrations/minute"];
var fact = [1, 1000000000000, 1000000000, 1000000, 1000, 0.001, 36999999995.93, 36999999995930, 37037037.037037, 37000.037000037, 37.000000037, 0.037000000000037, 1000000, 1, 1, 0.016666666666667];
