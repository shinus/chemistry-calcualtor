...
function calculateresult(){
    ...
    let element1value = inputdrop1.value;
    let element2val = parseFloat(input2.value);
    let element2value = inputdrop2.value;
    let element3val = parseFloat(input3.value);
    let element3value = inputdrop3.value;
    let element4val = parseFloat(input4.value);
    let element4value = inputdrop4.value;
    let element5val = parseFloat(input5.value);
    let element5value = inputdrop5.value;

    let element1 = elements.find(e => e.value === element1value);
    let element2 = elements.find(e => e.value === element2value);
    let element3 = elements.find(e => e.value === element3value);
    let element4 = elements.find(e => e.value === element4value);
    let element5 = elements.find(e => e.value === element5value);

    let molecularweight = 0;
    if (element1) molecularweight += element1.atomicMass * element1val;
    if (element2) molecularweight += element2.atomicMass * element2val;
    if (element3) molecularweight += element3.atomicMass * element3val;
    if (element4) molecularweight += element4.atomicMass * element4val;
    if (element5) molecularweight += element5.atomicMass * element5val;

console.log(molecularweight)
  //  result.innerText = ("The total molecular weight is " + molecularweight + "amu" + "amd");


let percent1 = ((element1.atomicMass * element1val) / molecularweight) * 100;
let percent2 = ((element2.atomicMass * element2val) / molecularweight) * 100;
let percent3 = ((element3.atomicMass * element3val) / molecularweight) * 100;
let percent4 = ((element4.atomicMass * element4val) / molecularweight) * 100;
let percent5 = ((element5.atomicMass * element5val) / molecularweight) * 100;
