...
var property = "fuel-efficiency-mass";

var box = [ "joule/kilogram (J/kg)", "kilojoule/kilogram (kJ/kg)", "calorie (IT)/gram (cal/g)", "calorie (th)/gram (cal (th)/g)", "Btu (IT)/pound (Btu/lb)", "Btu (th)/pound (Btu (th)/lb)", "kilogram/joule (kg/J)", "kilogram/kilojoule (kg/kJ)", "gram/calorie (IT) (g/cal)", "gram/calorie (th) (g/cal (th))", "pound/Btu (IT) (lb/Btu)", "pound/Btu (th) (lb/Btu (th))", "pound/horsepower/hour (lb/(hp*h))", "gram/horsepower (metric)/hour", "gram/kilowatt/hour (g/(kW*h))"];
var fact = [1, 1000, 4186.79818795374, 4183.9953808691, 2325.99791125388, 2324.44620069269, 1, 1000, 4186.8, 4184, 2326, 2324.444, 5918352.502, 2647795500, 3600000000];
