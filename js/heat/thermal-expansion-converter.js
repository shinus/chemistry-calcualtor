...
var property = "thermal-expansion";

var box = [ "length/kelvin (1/K)", "length/degree Celsius (1/°C)", "length/degree Fahrenheit (1/°F)", "length/degree Rankine (1/°R)", "length/degree Reaumur (1/°r)"];
var fact = [1, 1, 1.79999999856, 1.79999999856, 0.8];
