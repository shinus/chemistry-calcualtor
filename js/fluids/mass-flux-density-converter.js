...
var property = "mass-flux-density";

var box = [ "(g/(s*m²))", "(kg/(h*m²))", "(kg/(h*ft²))", "kg/sec/sqr meter", "gm/sec/sqr cm", "pd/hour/sqr ft (lb/(h*ft²))", "(lb/(s*ft²))"];
var fact = [1, 0.277777777777778, 2.9899751157527, 1000, 10000, 1.35622991378573, 4882.43106007343];
