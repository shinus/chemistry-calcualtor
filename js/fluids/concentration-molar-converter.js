...
var property = "concentration-molar";

var box = [ "mol/cubic meter (mol/m³)", "mol/liter (mol/L)", "mol/cubic centimeter (mol/cm³)", "mol/cubic millimeter (mol/mm³)", "kilomol/cubic meter (kmol/m³)", "kilomol/liter (kmol/L)", "kilomol/cubic centimeter (kmol/cm³)", "kilomol/cubic millimeter (kmol/mm³)", "millimol/cubic meter (mmol/m³)", "millimol/liter (mmol/L)", "millimol/cubic centimeter (mmol/cm³)", "millimol/cubic millimeter (mmol/mm³)"];
var fact = [1, 1000, 1000000, 1000000000, 1000, 1000000, 1000000000, 1000000000000, 0.001, 1, 1000, 1000000];
