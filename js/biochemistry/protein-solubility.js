let dropdowngrams = [
  ...
  calcBtn.addEventListener("click", () => {
    ...
    const proteinSolubility =
      1.401 * 6.25 * 5 * (standardBlankTiter - standardTiter) * standardNormality / standardEffectiveWeight;
  
    result.textContent = `Protein Solubility Percentage (p): ${proteinSolubility.toFixed(2)} %`;
  });
